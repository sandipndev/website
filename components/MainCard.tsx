...
const MainCard: NextPage = () => (
  <Card
    outerClassName="max-w-3xl antialiased backdrop-blur-sm hover:backdrop-blur -rotate-1 hover:scale-102 transform-gpu transition delay-50 ease-in-out duration-300"
