...
const SpotifyCard: NextPage = () => {
  ...
  return (
    <Card
      ...
      outerClassName={`bg-spotify bg-blend-color-dodge w-[28rem] h-24 transition-gpu ease-in-out duration-300 delay-50 ${(activity === "loading" || !activity) ? "opacity-80" : "opacity-100"}`}>
